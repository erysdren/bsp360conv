  ...
  preload_section:
    seq:
      - id: version
        type: u4be
        valid: 3
      - id: num_directory_entries
        type: u4be
      - id: num_preload_directory_entries
        type: u4be
      - id: alignment
        type: u4be
      - id: preload_directory_entries
        type: preload_directory_entry
        repeat: expr
        repeat-expr: num_preload_directory_entries
      - id: preload_directory_indices
        type: u2be
        repeat: expr
        repeat-expr: num_preload_directory_entries
